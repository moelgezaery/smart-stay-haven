      ...
      <CardContent className="grid grid-cols-2 gap-2">
        <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
          <DialogTrigger asChild>
            <Button 
              className="h-17 w-full flex flex-col items-center justify-center bg-hotel-blue-500 hover:bg-hotel-blue-600"
              style={{ height: "70px", width: "125%" }} // Increased width by ~25%, decreased height by ~15%
            >
              <div>
                <svg
        ...
        <Button
          variant="outline"
          className="h-17 w-full flex flex-col items-center justify-center border-dashed border-hotel-blue-300 text-hotel-blue-700"
          style={{ height: "70px" }} // Match the height of the Check In button
        >
          <div>
            <svg
              xmlns="http://www.w3.org/2000/svg"
