...
import { Search, CalendarClock, Clock, ArrowUpDown, Mail } from "lucide-react";
...
export default function ArrivalsToday() {
  ...
  const handleOpenEmailDialog = (guest: any) => {
    setSelectedGuest(guest);
    setEmailSubject(`Welcome to Gravity Smart Stay - Your Reservation ${guest.id}`);
    setEmailBody(`Dear ${guest.guestName},\n\nWe are looking forward to your arrival today at ${guest.arrivalTime}. Your room ${guest.room} will be ready for you.\n\nIf you need any assistance or have special requests, please don't hesitate to contact our front desk.\n\nBest regards,\nGravity Smart Stay Team`);
  ...
  const handleSendEmail = () => {
    ...
    toast({
      title: "Email Sent",
      description: `Welcome email has been sent to ${selectedGuest.guestName}.`
    });
                        ...
                        <TableCell>
                          <div className="flex space-x-2">
                            ...
                            <Button
                              variant="outline"
                              size="sm"
                              onClick={() => handleOpenEmailDialog(arrival)}
                            >
      ...
      <Dialog open={emailDialogOpen} onOpenChange={setEmailDialogOpen}>
        <DialogContent className="sm:max-w-[600px]">
          <DialogHeader>
            ...
            <DialogDescription>
              Send a welcome email to {selectedGuest?.guestName} ({selectedGuest?.email})
            </DialogDescription>
          </DialogHeader>
          <div className="grid gap-4 py-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              <label htmlFor="body" className="text-right font-medium">
                Message
              </label>
              <Textarea
                id="body"
